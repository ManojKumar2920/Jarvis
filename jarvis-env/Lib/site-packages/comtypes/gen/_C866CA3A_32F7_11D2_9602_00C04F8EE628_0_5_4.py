...
__all__ = [
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLPsItem', 'DISPID_SGRClear',
    'SSFMCreate', 'DISPID_SPPConfidence', 'DISPID_SPRulesCount',
    'SPAO_NONE', 'SPVISEMES', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVSLastResult', 'DISPID_SPCIdToPhone',
    'ISpeechPhraseReplacement', 'SpeechGrammarTagUnlimitedDictation',
    'SVSFPersistXML', 'SPEI_TTS_PRIVATE', 'SPEI_TTS_BOOKMARK',
    'SpeechAudioVolume', 'DISPID_SPIRule',
    'DISPID_SpeechCustomStream', 'SPCT_SLEEP', 'SRARoot',
    'SAFT22kHz16BitMono', 'DISPID_SVSInputSentencePosition',
    'SPPHRASEELEMENT', 'DISPID_SGRSTType',
    'DISPID_SPIRetainedSizeBytes', 'SpeechGrammarTagDictation',
    'SPSVerb', 'SSTTDictation', 'DISPID_SGRSTsCount',
    'ISpeechPhraseInfo', 'DISPID_SVGetVoices', 'SFTSREngine',
    'ISpPhoneConverter', 'SPCT_SUB_COMMAND', 'SPSERIALIZEDRESULT',
    'ISpeechGrammarRuleState', 'ISpShortcut', 'SPAR_Medium',
    'Speech_StreamPos_Asap', 'DISPID_SpeechBaseStream',
    'SAFT12kHz8BitMono', 'SSTTTextBuffer',
    'SDA_Consume_Leading_Spaces', 'SREFalseRecognition',
    'ISpMMSysAudio', 'DISPID_SRCERecognitionForOtherContext',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE2',
    'IInternetSecurityManager', 'DISPID_SPEAudioTimeOffset',
    'ISpRecoGrammar2', 'SPRECOGNIZERSTATUS', 'SVEAllEvents',
    'DISPID_SOTCSetId', 'ISpeechAudioStatus', 'SPEI_VISEME',
    'SP_VISEME_10', 'SDTProperty', 'STCLocalServer',
    'DISPID_SVSRunningState', 'SAFT16kHz16BitMono', 'DISPID_SFSClose',
    'DISPID_SRCRetainedAudioFormat', 'SAFTNonStandardFormat',
    'SAFTADPCM_22kHzStereo', 'SPEI_SR_PRIVATE', 'SVSFParseAutodetect',
    'SPPS_RESERVED3', 'DISPID_SPRuleParent', 'SPCT_DICTATION',
    'DISPID_SVVolume', 'SITooQuiet', 'SPSHT_Unknown', 'SVP_1',
    '__MIDL_IWinTypes_0009', 'SpeechWordType', 'DISPID_SLPType',
    'SVP_13', 'DISPID_SVEVoiceChange', 'DISPID_SRRTStreamTime',
    'SVEPhoneme', 'SPAS_RUN', 'ISpeechGrammarRuleStateTransitions',
    'SPINTERFERENCE_TOOSLOW', 'SDKLLocalMachine',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCERequestUI',
    'SPBOOKMARKOPTIONS', 'DISPID_SRCPause', 'DISPID_SVStatus',
    'DISPID_SGRsCommitAndSave', 'SpeechVisemeType',
    'DISPID_SVSInputWordLength', 'DISPID_SRGDictationLoad',
    'DISPID_SGRsItem', 'eLEXTYPE_RESERVED4', 'SRSActiveAlways',
    'SGLexicalNoSpecialChars', 'DISPID_SGRName',
    'SAFT24kHz8BitStereo', 'DISPID_SGRSRule',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRSetPropertyString',
    'DISPID_SVEBookmark', 'SRATopLevel',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechStreamSeekPositionType', 'ISpNotifyTranslator',
    'ISpeechPhraseRule', 'DISPID_SRGDictationSetState',
    'SpeechPropertyResourceUsage', 'eWORDTYPE_DELETED',
    'SPWORDPRONOUNCEABLE', 'SPEI_SOUND_END', 'eLEXTYPE_PRIVATE16',
    'SDTLexicalForm', 'SPLOADOPTIONS', 'SPINTERFERENCE_NOISE',
    'SPVPRI_OVER', 'DISPID_SpeechRecoContextEvents',
    'SPEI_SOUND_START', 'SRAExport', 'eLEXTYPE_RESERVED6',
    'SREAudioLevel', 'ISpeechObjectTokenCategory',
    'DISPID_SLPSymbolic', 'SDTAll', 'SPRECOSTATE',
    'SECNormalConfidence', 'SpMemoryStream', 'DISPID_SPARecoResult',
    'SECHighConfidence', 'DISPID_SDKSetLongValue',
    'DISPID_SRSCurrentStreamPosition', 'SPAR_Low',
    'SpeechWordPronounceable', 'SPSHT_OTHER', 'SPRULE',
    'SpPhoneticAlphabetConverter', 'SPWT_DISPLAY', 'SITooFast',
    'DISPID_SOTRemove', 'ISpeechPhraseProperties',
    'SGDSActiveWithAutoPause', 'SPSMF_SAPI_PROPERTIES', 'SVPOver',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechDataKey', 'SREStreamStart', 'SPSMF_UPS',
    'SPEI_ADAPTATION', 'ISpRecognizer3', 'DISPID_SVPause',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVEStreamStart', 'SRSEDone',
    'SGLexical', 'SREPropertyNumChange', 'DISPID_SRRAudio',
    'SP_VISEME_8', 'DISPID_SLWs_NewEnum', 'SP_VISEME_20',
    'ISpeechPhraseAlternate', 'ISpeechCustomStream',
    'SAFT12kHz16BitStereo', 'SP_VISEME_3', 'DISPID_SGRSTsItem',
    'DISPID_SpeechAudioFormat', 'SPCS_DISABLED',
    'DISPID_SPIGrammarId', 'SVSFNLPSpeakPunc', 'STCRemoteServer',
    'SREStreamEnd', 'SPFM_NUM_MODES', 'DISPID_SASNonBlockingIO',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTId', 'IEnumString', 'SPBO_TIME_UNITS',
    'DISPID_SRGDictationUnload', 'SPEI_RESERVED5', 'SREAdaptation',
    'DISPID_SPRuleId', 'SAFT48kHz8BitMono',
    'DISPID_SGRSAddSpecialTransition', 'SPSTREAMFORMATTYPE',
    'SPXMLRESULTOPTIONS', 'DISPID_SpeechPhraseProperty', 'SPBO_NONE',
    'SVSFIsFilename', 'SLOStatic', 'DISPID_SOTsCount',
    'DISPID_SRState', 'DISPID_SPACommit', 'DISPID_SVSLastBookmark',
    'SDTReplacement', 'SpeechLoadOption', 'SVP_7', 'SVP_16',
    'DISPID_SRCreateRecoContext', 'SASPause',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechRecoResult',
    'DISPID_SLWType', 'STSF_CommonAppData', 'SpeechAudioProperties',
    'SASRun', 'DISPID_SRCEPropertyNumberChange', 'SVSFIsXML',
    'DISPID_SGRAddResource', 'eWORDTYPE_ADDED', 'ISpGrammarBuilder',
    'SpPhraseInfoBuilder', 'SWTDeleted', 'DISPID_SGRAddState',
    'SpeechMicTraining', 'DISPID_SDKEnumKeys', 'DISPID_SRCBookmark',
    'SVSFPurgeBeforeSpeak', 'SPEI_MIN_SR', 'DISPID_SGRSTransitions',
    'DISPID_SPRulesItem', 'SPPHRASEREPLACEMENT', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVEventInterests', 'DISPID_SDKSetBinaryValue',
    'SECFNoSpecialChars', 'DISPID_SRRAlternates',
    ...
    'SVEEndInputStream', 'SREPhraseStart', 'SPEI_RESERVED3',
    'SpeechPropertyAdaptationOn', 'STCInprocHandler',
    'DISPID_SPIGetText', 'SSFMOpenForRead', 'ISpeechBaseStream',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechMemoryStream', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    ...
    'DISPID_SPRuleChildren', 'SP_VISEME_13', 'ISpeechGrammarRules',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISequentialStream',
    'SpeechEngineConfidence', 'DISPID_SPEAudioSizeTime', 'SVP_12',
    'SpeechGrammarWordType', 'SPXRO_Alternates_SML', 'ISpeechDataKey',
    'SWPUnknownWordPronounceable', 'SPSNotOverriden',
    'DISPID_SpeechPhraseProperties', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPRuleConfidence', 'SVSFlagsAsync',
    'DISPID_SPEAudioSizeBytes', 'ISpPhoneticAlphabetConverter',
    'SDTPronunciation', 'SPPROPERTYINFO', 'SGDSInactive',
    'DISPID_SOTGetAttribute', 'DISPID_SDKGetBinaryValue', 'SVPAlert',
    'SVF_Stressed', 'SPBO_AHEAD', 'DISPID_SRIsShared',
    'DISPID_SVEStreamEnd', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_VOICE_CHANGE', 'SPVPRI_ALERT', 'eLEXTYPE_MORPHOLOGY',
    'SPPS_Noncontent', 'SVP_10', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPELexicalForm', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_PRIVATE1', 'SPFILEMODE', 'SPSInterjection', 'SPPS_Verb',
    ...
    'IInternetSecurityMgrSite', 'DISPID_SRCState',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRCEventInterests',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_14', 'SVP_2',
    'DISPID_SVEViseme', 'SpMMAudioOut', 'SpeechGrammarState',
    'SRSActive', 'SpSharedRecoContext', 'SpeechDiscardType',
    'SWPKnownWordPronounceable', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGSetTextSelection',
    'DISPID_SLPsCount', 'DISPID_SGRSTWeight', 'STSF_AppData',
    'SLTApp', 'SpeechPartOfSpeech', '_SPAUDIOSTATE',
    'SAFTGSM610_44kHzMono', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT16kHz16BitStereo', 'SpeechVoicePriority',
    ...
    'DISPID_SGRSTPropertyValue', 'DISPID_SRGIsPronounceable',
    'tagSTATSTG', 'ISpeechPhraseReplacements',
    'DISPID_SPRuleNumberOfElements', 'SPWF_SRENGINE',
    'DISPID_SGRSTs_NewEnum', 'SAFT24kHz16BitMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE11', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechXMLRecoResult', 'SpeechRecoProfileProperties',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SP_VISEME_1', 'DISPID_SMSGetData',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVEPhoneme', 'SREAllEvents',
    'SAFT8kHz8BitMono', 'SPAUDIOBUFFERINFO', 'DISPID_SRRSaveToMemory',
    'SPPS_RESERVED2', 'DISPID_SBSRead', 'SpNullPhoneConverter',
    'DISPID_SRProfile', 'SRADynamic', 'SpeechCategoryVoices',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVAudioOutputStream',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVGetAudioInputs', 'SAFTCCITT_uLaw_11kHzMono',
    'SPSHORTCUTTYPE', 'SINoSignal', 'SpObjectToken', 'SITooSlow',
    'SRAONone', 'DISPID_SpeechLexiconWord', 'SVSFIsNotXML',
    'SDA_One_Trailing_Space', 'DISPIDSPRG',
    'DISPID_SpeechRecognizerStatus', 'ISpeechRecoResultTimes',
    'SPSFunction', 'ISpeechPhraseProperty', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRInitialState', 'SPDKL_LocalMachine', 'SPWORDTYPE',
    'SpeechRecognizerState', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechLexicon', 'DISPID_SLWPronunciations', 'SpMMAudioIn',
    'ISpProperties', 'DISPID_SPEsItem', 'DISPID_SRRPhraseInfo',
    'SAFTADPCM_44kHzMono', 'DISPID_SMSADeviceId',
    'DISPID_SWFEAvgBytesPerSec', 'SASStop', 'SAFTGSM610_11kHzMono',
    'ISpRecoContext2', 'SpeechCategoryAudioIn', 'DISPID_SGRsAdd',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT8kHz16BitMono',
    '_ISpeechVoiceEvents', 'SPFM_CREATE', 'SP_VISEME_7',
    'DISPID_SVSPhonemeId', 'SAFT12kHz16BitMono', 'SPFM_CREATE_ALWAYS',
    'SREInterference', 'DISPID_SpeechPhoneConverter', 'SGDisplay',
    'DISPID_SBSSeek', 'DISPID_SLGetWords', 'SREPropertyStringChange',
    'ISpObjectWithToken', 'SAFTCCITT_ALaw_44kHzMono', 'SRSInactive',
    'SAFTADPCM_44kHzStereo', 'SPEI_PHRASE_START',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechMemoryStream',
    'DISPID_SVSpeak', 'ISpeechLexiconWord',
    'DISPID_SDKSetStringValue', 'SAFTNoAssignedFormat', 'SPAR_High',
    'SPEI_SR_RETAINEDAUDIO', 'SVSFParseSsml', 'SpResourceManager',
    'Speech_Max_Pron_Length', 'SAFT24kHz8BitMono',
    'eLEXTYPE_PRIVATE13', 'DISPID_SASCurrentDevicePosition',
    'SAFT44kHz8BitStereo', 'SpeechRecoEvents', 'SGPronounciation',
    'SAFT44kHz16BitStereo', 'DISPID_SASState', 'SAFT22kHz16BitStereo',
    'IEnumSpObjectTokens', 'ISpeechRecoContext', 'DISPID_SOTCId',
    'SAFTADPCM_11kHzStereo', 'SPCONTEXTSTATE',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechRecoResult',
    'SPDKL_CurrentUser', 'SGDSActive',
    'DISPID_SASCurrentSeekPosition', 'ISpPhrase',
    'SAFT48kHz8BitStereo', 'SVSFVoiceMask', 'SPLO_DYNAMIC',
    'DISPID_SPEActualConfidence', 'SPAUDIOSTATUS', 'SpeechRunState',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPERetainedSizeBytes',
    'ISpRecoResult', 'DISPID_SDKOpenKey', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVEAudioLevel', 'DISPID_SRAudioInput',
    'SpeechRecognitionType', 'SpeechDataKeyLocation',
    'DISPID_SGRSTPropertyName', 'SpeechUserTraining',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpMMAudioEnum',
    'DISPID_SDKDeleteValue', 'ISpPhoneticAlphabetSelection',
    'DISPIDSPTSI_ActiveOffset', 'SPPARTOFSPEECH',
    'SAFT32kHz16BitMono', 'SRAORetainAudio', 'SPWORD',
    'DISPID_SASetState', 'DISPID_SVSpeakStream', 'ISpEventSource',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCEAdaptation', 'SP_VISEME_12',
    'DISPID_SVPriority', 'SINone', 'SpShortcut',
    'DISPID_SPEs_NewEnum', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseInfo', 'SAFT48kHz16BitStereo', 'SGSExclusive',
    'SPSHT_NotOverriden', 'SDTRule', 'DISPID_SDKGetlongValue',
    'SAFTExtendedAudioFormat', 'SpeechAddRemoveWord',
    'SPPS_RESERVED4', 'SPEI_RECO_STATE_CHANGE', 'SSFMOpenReadWrite',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SBSWrite',
    'DISPID_SVSLastStreamNumberQueued', 'SPRS_INACTIVE',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SCSBaseStream',
    'eLEXTYPE_PRIVATE12', 'SVP_20', 'DISPID_SVSyncronousSpeakTimeout',
    'eLEXTYPE_PRIVATE6', 'SPGS_DISABLED', 'SPEI_MAX_TTS',
    'SECFDefault', 'DISPID_SLWsItem', 'SP_VISEME_0',
    'SpeechRuleState', 'ISpeechPhraseElements', 'SPSHORTCUTPAIR',
    'DISPID_SPRules_NewEnum', 'DISPID_SLPPhoneIds', 'SVPNormal',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRAttributes',
    'SPPS_Noun', 'SINoise', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVResume', 'SDKLDefaultLocation', 'DISPID_SRCVoice',
    'DISPID_SVEWord', 'SGSDisabled', 'ISpeechGrammarRule',
    'DISPID_SVSInputWordPosition', 'DISPID_SPRFirstElement',
    'SVSFDefault', 'STSF_FlagCreate', 'eLEXTYPE_PRIVATE3', 'SPSLMA',
    'DISPID_SAEventHandle', 'SAFT16kHz8BitStereo',
    'DISPID_SABufferNotifySize', 'DISPID_SPPId', 'SpCustomStream',
    'DISPID_SPEDisplayText', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SOTIsUISupported', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPFM_OPEN_READONLY', 'ISpeechWaveFormatEx', 'ISpResourceManager',
    'SpeechGrammarTagWildcard', 'DISPID_SRRAudioFormat',
    'SRSInactiveWithPurge', 'DISPID_SWFEExtraData',
    'DISPID_SVDisplayUI', 'STCInprocServer', 'DISPID_SRCEAudioLevel',
    'SPEI_START_SR_STREAM', 'SPEI_RESERVED1', 'ISpeechPhraseRules',
    'DISPID_SGRsFindRule', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRStatus', 'SPEI_START_INPUT_STREAM',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechGrammarRule',
    'SPWORDPRONUNCIATION', 'SDTAudio',
    'DISPID_SVSInputSentenceLength', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_RESERVED10', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechVoice', 'SPEVENTENUM',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRuleName',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE18', 'DISPID_SpeechAudio',
    'SVP_8', 'SPVPRIORITY', 'SpeechInterference',
    'DISPID_SRRRecoContext', 'DISPID_SPPName', 'SASClosed', 'SVP_14',
    'SPGS_ENABLED', 'eLEXTYPE_PRIVATE4', 'SPAUDIOSTATE',
    'SAFT8kHz8BitStereo', 'SRTStandard', 'SAFT32kHz8BitStereo',
    'SAFT32kHz8BitMono', 'ISpStreamFormatConverter', 'eLEXTYPE_USER',
    'SGSEnabled', 'SECFIgnoreWidth', 'ISpNotifySource',
    'DISPID_SRRGetXMLErrorInfo', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPAsCount', 'SPSUnknown', 'DISPID_SRCEBookmark',
    'SPAS_CLOSED', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPFM_OPEN_READWRITE', 'SAFT11kHz8BitStereo', 'SVP_21',
    'DISPID_SPIStartTime', 'DISPID_SPPsItem', 'ISpeechAudio',
    'SpeechRegistryUserRoot', 'SpeechBookmarkOptions',
    'SpeechTokenValueCLSID', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTs_NewEnum', 'SSFMCreateForWrite', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_RESERVED9', 'SVP_15', 'SVSFNLPMask',
    'ISpeechRecoGrammar', 'SPEI_MAX_SR', 'SRSEIsSpeaking',
    'SPSSuppressWord', 'DISPID_SPPParent', 'SPGS_EXCLUSIVE',
    'DISPID_SVVoice', 'DISPID_SPEPronunciation',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRs_NewEnum',
    'SECLowConfidence', 'SpeechTokenShellFolder', 'DISPID_SRGCommit',
    'tagSPPROPERTYINFO', 'SBOPause', 'ISpeechAudioBufferInfo',
    'ISpNotifySink', 'SAFTCCITT_uLaw_11kHzStereo', 'ISpStream',
    'DISPID_SRRGetXMLResult', 'SpVoice', 'ISpRecoGrammar',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPPs_NewEnum',
    'DISPID_SPAPhraseInfo', 'SVEBookmark', 'SpeechTokenKeyUI',
    'SAFT44kHz8BitMono', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SDKCreateKey',
    'SpeechCategoryAppLexicons', 'SPPS_Function',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPS_RESERVED1',
    'DISPID_SpeechPhraseRules', 'SPDKL_CurrentConfig',
    'SPINTERFERENCE_NONE', 'ISpeechRecognizer', 'DISPID_SGRSTRule',
    'ISpeechVoice', 'SLTUser', 'SPEI_MIN_TTS', 'SPEI_END_SR_STREAM',
    'DISPID_SRAudioInputStream', 'DISPID_SADefaultFormat', 'SVP_5',
    'DISPID_SpeechObjectToken', 'SpeechRetainedAudioOptions',
    'SPPS_NotOverriden', 'SRESoundEnd', 'DISPID_SLPPartOfSpeech',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SLPLangId',
    'DISPID_SPAsItem', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechLexicon', 'SPAUDIOOPTIONS', 'SAFT22kHz8BitMono',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_LETTERTOSOUND',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCRecognizer', 'ISpXMLRecoResult',
    'SECFEmulateResult', 'DISPID_SPAs_NewEnum',
    'DISPID_SPIProperties', 'SP_VISEME_4', 'DISPID_SAVolume',
    'DISPID_SABIBufferSize', 'SAFT24kHz16BitStereo',
    'SpPhoneConverter', 'SRESoundStart', 'DISPID_SPPValue',
    'SDA_No_Trailing_Space', 'ISpObjectToken', 'SAFT12kHz8BitStereo',
    'DISPID_SRCESoundEnd', 'DISPID_SFSOpen',
    'ISpeechGrammarRuleStateTransition',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechVoiceEvents',
    'SPWF_INPUT', 'SPSERIALIZEDPHRASE', 'SpSharedRecognizer',
    'SGRSTTEpsilon', 'SVEPrivate', 'SPINTERFERENCE_TOOLOUD',
    'SAFT8kHz16BitStereo', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVWaitUntilDone', 'ISpeechResourceLoader', 'ISpLexicon',
    'ISpStreamFormat', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SREBookmark', 'DISPID_SBSFormat', 'SRAImport',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechRecoResult2',
    'SpeechLexiconType', 'SAFTADPCM_22kHzMono',
    'DISPID_SRSClsidEngine', 'SFTInput', 'DISPID_SVAlertBoundary',
    'SpInprocRecognizer', 'DISPID_SVEEnginePrivate',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SDKEnumValues', 'SVP_6',
    'SpeechTokenKeyFiles', 'SAFTCCITT_ALaw_8kHzMono',
    '_RemotableHandle', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPAStartElementInResult', 'SpeechTokenIdUserLexicon',
    'DISPID_SMSSetData', 'DISPID_SRCEInterference', 'SRERequestUI',
    'DISPID_SpeechObjectTokenCategory', 'SVSFParseSapi', 'SVP_17',
    'SpStreamFormatConverter', 'DISPID_SPIEngineId',
    'DISPID_SDKGetStringValue', 'DISPID_SABufferInfo',
    'SPEVENTSOURCEINFO', 'SPWAVEFORMATTYPE',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_PRIVATE5',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPERequiredConfidence',
    'DISPID_SRCESoundStart', 'DISPID_SOTGetDescription',
    'SpInProcRecoContext', 'DISPID_SLAddPronunciation',
    'SPCT_COMMAND', 'SAFT11kHz16BitStereo', 'SP_VISEME_18',
    'SPRECORESULTTIMES', 'DISPID_SPILanguageId',
    'SpeechGrammarRuleStateTransitionType', 'Speech_Max_Word_Length',
    'SPXRO_SML', 'SDTDisplayText', 'SP_VISEME_2',
    'DISPID_SMSAMMHandle', 'SpFileStream', 'SPRULESTATE',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPS_SuppressWord', 'DISPID_SpeechGrammarRuleState',
    'SVEVoiceChange', 'SAFT44kHz16BitMono', 'SVF_Emphasis',
    'SPSHT_EMAIL', 'SRTEmulated', 'DISPID_SDKDeleteKey',
    'SAFTGSM610_8kHzMono', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SRSSupportedLanguages', 'SpeechCategoryRecognizers',
    'DISPID_SAFSetWaveFormatEx', 'SVP_9', 'ISpeechRecoResult2',
    'SDKLCurrentUser', 'SPWT_LEXICAL', 'SPRST_NUM_STATES',
    'SVEViseme', 'ISpeechAudioFormat', 'SSSPTRelativeToEnd',
    'SpeechRecoContextState', 'SRTAutopause', 'SPINTERFERENCE',
    'DISPID_SRRDiscardResultInfo', '_ISpeechRecoContextEvents',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLWLangId',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_PRIVATE17', 'SGRSTTDictation', 'SPAR_Unknown',
    'SpeechAllElements', 'SAFTText', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRSTPropertyId', 'SPLO_STATIC',
    'DISPID_SpeechObjectTokens', 'DISPID_SWFEBlockAlign',
    'DISPID_SVSVisemeId', 'ISpAudio', 'eLEXTYPE_PRIVATE7', 'SVP_4',
    'eLEXTYPE_APP', 'SAFTCCITT_ALaw_44kHzStereo', 'SP_VISEME_16',
    'DISPID_SPIAudioSizeBytes', 'SpStream',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLGenerationId',
    'SPRST_ACTIVE', 'STSF_LocalAppData', 'SpUnCompressedLexicon',
    'DISPID_SLWWord', 'SRCS_Disabled', 'DISPID_SRGState',
    ...
    'DISPID_SRDisplayUI', 'SGRSTTWord', 'SVP_3',
    'SpeechTokenKeyAttributes', 'SPCATEGORYTYPE', 'SpeechFormatType',
    'SAFTDefault', 'SPEI_RESERVED2', 'DISPID_SPRNumberOfElements',
    'ISpeechLexiconWords', 'DISPID_SPIEnginePrivateData',
    'DISPID_SGRSTText', 'ISpSerializeState', 'SpeechAudioState',
    'SPDKL_DefaultLocation', 'SPTEXTSELECTIONINFO', 'SREStateChange',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVESentenceBoundary',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechPhraseAlternates',
    'SpeechAudioFormatGUIDWave', 'SPEI_END_INPUT_STREAM',
    'SAFT11kHz16BitMono', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPRsCount', 'SP_VISEME_19', 'DISPID_SOTDataKey',
    'SVSFParseMask', 'DISPID_SRCResume', 'SP_VISEME_11',
    'SpeechEmulationCompareFlags', 'SpeechDisplayAttributes',
    'DISPID_SpeechPhraseElement', 'SP_VISEME_21', 'ISpRecoCategory',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPPFirstElement',
    'SpCompressedLexicon', 'SPDATAKEYLOCATION', 'DISPID_SRGRules',
    ...
    'SRAInterpreter', 'SAFTCCITT_uLaw_22kHzMono', 'SDTAlternates',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SOTsItem', 'DISPID_SPCLangId', 'SGRSTTWildcard',
    'DISPID_SAStatus', 'SPEI_HYPOTHESIS', 'SPEI_RESERVED6',
    'DISPID_SPPsCount', 'SPGRAMMARWORDTYPE', 'DISPIDSPTSI',
    'UINT_PTR', 'SPSNoun', 'SVP_11', 'DISPID_SRRTLength',
    'ISpeechObjectTokens', 'DISPID_SRRTimes', 'SpeechTokenContext',
    'SpeechCategoryRecoProfiles', 'SREPrivate',
    'SPEI_TTS_AUDIO_LEVEL', 'SPPS_Modifier', 'SRADefaultToActive',
    'SAFT16kHz8BitMono', 'DISPID_SGRId', 'SRCS_Enabled', 'SPAS_PAUSE',
    'SPPHRASERULE', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFUnusedFlags',
    'SREHypothesis', 'DISPID_SPPEngineConfidence',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPISaveToMemory',
    'SGDSActiveUserDelimited', 'SAFT48kHz16BitMono',
    'DISPID_SpeechAudioStatus', 'DISPID_SRGRecoContext',
    'SpeechDictationTopicSpelling', 'SAFT22kHz8BitStereo', 'SPEVENT',
    'DISPID_SRRTTickCount', 'SRTReSent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRRecognizer',
    'SPRS_ACTIVE', 'eLEXTYPE_PRIVATE10', 'DISPID_SRCEEnginePrivate',
    'DISPID_SOTDisplayUI', 'DISPID_SREmulateRecognition',
    'ISpeechPhoneConverter', 'DISPID_SpeechFileStream',
    'DISPID_SpeechVoiceEvent', 'ISpeechMMSysAudio', 'SGRSTTRule',
    'SVEWordBoundary', 'SSTTWildcard', 'ISpVoice',
    'DISPID_SPIElements', 'DISPID_SRCEHypothesis',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSAddWordTransition',
    'ISpRecoContext', 'DISPID_SVAudioOutput', 'SP_VISEME_9',
    'LONG_PTR', 'DISPID_SRCRetainedAudio', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechRecoContext', 'ISpeechRecognizerStatus',
    'ISpeechPhraseElement', 'SVEAudioLevel',
    'DISPID_SLGetGenerationChange', 'SPCS_ENABLED',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SWFEBitsPerSample', 'SP_VISEME_17',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRsCommit',
    'SPAO_RETAIN_AUDIO', 'SpeechVisemeFeature',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechRecognizer',
    'DISPID_SRCRequestedUIType', 'DISPID_SLGetPronunciations',
    'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE15', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SABIEventBias', 'DISPID_SRGCmdSetRuleIdState',
    'ISpRecognizer', 'DISPID_SVGetProfiles', 'DISPID_SWFEFormatTag',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVSLastBookmarkId',
    'SPSEMANTICFORMAT', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseRule', 'SRERecognition', 'DISPID_SVRate',
    'SPGRAMMARSTATE', 'WAVEFORMATEX', 'DISPID_SRGId',
    'tagSPTEXTSELECTIONINFO', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRCEEndStream', 'SPEI_SR_BOOKMARK', 'ISpeechObjectToken',
    'SpWaveFormatEx', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVIsUISupported', 'DISPID_SPPNumberOfElements',
    'SPBO_PAUSE', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechTextSelectionInformation',
    'DISPID_SPIGetDisplayAttributes', 'SRTExtendableParse',
    'DISPID_SpeechPhraseElements', 'Speech_Default_Weight',
    'SVEStartInputStream', 'DISPID_SPIReplacements',
    ...
    'DISPID_SPEAudioStreamOffset', 'ISpRecognizer2', 'SBONone',
    'SITooLoud', 'ISpEventSink', 'STCAll', 'SPPS_Interjection',
    'SPEI_RECOGNITION', 'DISPID_SPRText', 'ISpPhraseAlt',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRsDynamic', 'SLODynamic',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechAudioBufferInfo',
    'SPBINARYGRAMMAR', 'DISPID_SPPChildren', 'SVP_18',
    'DISPID_SRGReset', 'SpeechPropertyResponseSpeed',
    'ISpeechFileStream', 'SAFTADPCM_8kHzStereo', 'SpLexicon',
    'SpeechCategoryAudioOut', 'SpeechAudioFormatType', 'SPPS_Unknown',
    'SP_VISEME_6', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCERecognition', 'SpeechSpecialTransitionType',
    'SPEI_WORD_BOUNDARY', 'SPEI_PROPERTY_NUM_CHANGE', 'SVF_None',
    'SSSPTRelativeToStart', 'SpTextSelectionInformation',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPEEngineConfidence',
    'SPCT_SUB_DICTATION', 'SPRST_INACTIVE', 'SPWT_PRONUNCIATION',
    'SPPHRASE', 'SAFTGSM610_22kHzMono', 'SPVOICESTATUS',
    'SAFT11kHz8BitMono', 'SP_VISEME_15', 'SRERecoOtherContext',
    'DISPID_SPEsCount', 'DISPID_SGRsCount', 'SRTSMLTimeout',
    'SPPS_LMA', 'DISPID_SAFType', 'DISPID_SRIsUISupported',
    'DISPID_SpeechPhraseAlternate', 'SDKLCurrentConfig',
    'DISPID_SRRSpeakAudio', 'SVESentenceBoundary', 'ISpDataKey',
    'SGRSTTTextBuffer', 'SECFIgnoreKanaType', 'SpObjectTokenCategory',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SOTCreateInstance',
    'SpeechVoiceSpeakFlags', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRGCmdLoadFromResource', 'SVP_19', 'SECFIgnoreCase',
    'SPAS_STOP', 'DISPID_SLWsCount', 'SWTAdded', 'DISPID_SRGetFormat',
    'DISPID_SRCCreateResultFromMemory', 'ISpObjectTokenCategory',
    'SP_VISEME_5', 'SPSModifier', 'DISPID_SOTCategory',
    'SPLEXICONTYPE', 'IStream', 'SpeechEngineProperties',
    'DISPID_SRGCmdLoadFromMemory', 'SVP_0', 'SpeechStreamFileMode',
    'ISpeechVoiceStatus', 'DISPID_SMSALineId', 'SPVPRI_NORMAL'
]

_check_version('1.2.1', 1701490862.879979)
